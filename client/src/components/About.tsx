  ...
  return (
    <div className=" max-w-5xl mx-auto mb-52 p-2" id="about">
      <div className=" flex flex-col md:flex-row gap-7">
        <img
          className=" object-cover h-[400px] w-full md:w-[400px] rounded-md"
        ...
        <div className=" flex flex-col">
          <h2 className=" uppercase mb-4 font-bold text-blue-600 text-lg text-center sm:text-start">
            About me
          </h2>
          <h1 className=" font-bold text-2xl text-center sm:text-start">
            A dedicated Full-stack Developer based in Amman, Jordan
          </h1>
          <p className=" mt-4 text-lg text-gray-500 leading-7 text-center sm:text-start">
            As a Full-stack Developer, I posses an impressive arsenal
            of skills in HTML, CSS, Javascript, Typescript, react,
            tailwind, nodejs, Express, Mongodb, I excel designing and
            maintaining responsive websites that offer a smooth user
            experience, My expertise lies in craftring dynamic,
